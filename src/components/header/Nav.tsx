...
const Nav = () => {
  ...
  return (
    <>
      <nav className="w-[100%] h-full flex gap-4 justify-end lg:justify-around  items-center col-span-2">
        <div className=" xl:flex justify-between items-center gap-[10px] w-[80%]">
          {/* <NavList /> */}
          <Switch />
          {/* <AuthButtons /> */}
        </div>
